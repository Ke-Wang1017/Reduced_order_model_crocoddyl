...
class ActuationModelBipedContactVertex(crocoddyl.ActuationModelAbstract):
    ...
    def updateJacobians(self, data):
        if self._updateVertexes:
            ...
            data.dtau_du[1, 1:] = [self._vs[1, 0] - self._vs[1, -1], self._vs[1, 1] - self._vs[1, -1],
                                   self._vs[1, 2] - self._vs[1, -1], self._vs[1, 3] - self._vs[1, -1],
                                   self._vs[1, 4] - self._vs[1, -1], self._vs[1, 5] - self._vs[1, -1],
                                   self._vs[1, 6] - self._vs[1, -1]]
            data.dtau_du[2, 1:] = [self._vs[2, 0] - self._vs[2, -1], self._vs[2, 1] - self._vs[2, -1],
                                   self._vs[2, 2] - self._vs[2, -1], self._vs[2, 3] - self._vs[2, -1],
                                   self._vs[2, 4] - self._vs[2, -1], self._vs[2, 5] - self._vs[2, -1],
